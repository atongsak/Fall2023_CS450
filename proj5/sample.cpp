...
const char *WINDOWTITLE = "CS 450 Project #5 -- Annette Tongsak";
...
const int MS_PER_CYCLE = 6000;		// 10000 milliseconds = 10 seconds
...
Display( )
{
	...
	if(inLightingMode){
		...
		glPushMatrix();
		float posX = 2*sin(4*M_PI*Time);
		float posZ = 2*cos(4*M_PI*Time);
		float orientationAngle = atan2(-posZ, posX);
		glRotatef(orientationAngle * 180/M_PI, 0, 1, 0);
		if(displayPlanet == 0){ // venus
			glTranslatef(2.95, 0, 0);
			SetPointLight(GL_LIGHT0, 0, 0, 0, 1.95, 1.95, 1.95);
		} else if(displayPlanet == 1){ // earth
			glTranslatef(3, 0, 0);
			SetPointLight(GL_LIGHT0, 0, 0, 0, 2., 2., 2.);
		} else if(displayPlanet == 2){ // mars
			glTranslatef(2.53, 0, 0);
			SetPointLight(GL_LIGHT0, 0, 0, 0, 1.53, 1.53, 1.53);
		} else if(displayPlanet == 3){ // jupiter
			glTranslatef(30, 0, 0);
			SetPointLight(GL_LIGHT0, 0, 0, 0, 12.21, 12.21, 12.21);
		} else if(displayPlanet == 4){ // saturn
			glTranslatef(28, 0, 0);
			SetPointLight(GL_LIGHT0, 0, 0, 0, 10.45, 10.45, 10.45);
		} else if(displayPlanet == 5){ // uranus
			glTranslatef(10, 0, 0);
			SetPointLight(GL_LIGHT0, 0, 0, 0, 5.01, 5.01, 5.01);
		} else if(displayPlanet == 6){ // neptune
			glTranslatef(13, 0, 0);
			SetPointLight(GL_LIGHT0, 0, 0, 0, 4.88, 4.88, 4.88);	
		}
...
InitGraphics( )
{
	...
	unsigned char *texture0 = BmpToTexture( "venus.bmp", &width0, &height0 );	
	unsigned char *texture1 = BmpToTexture( "earth.bmp", &width1, &height1 );	
	unsigned char *texture2 = BmpToTexture( "mars.bmp", &width2, &height2 );		
	unsigned char *texture3 = BmpToTexture( "jupiter.bmp", &width3, &height3 );	
	unsigned char *texture4 = BmpToTexture( "saturn.bmp", &width4, &height4 );	
	unsigned char *texture5 = BmpToTexture( "uranus.bmp", &width5, &height5 );	
	unsigned char *texture6 = BmpToTexture( "neptune.bmp", &width6, &height6 );	
