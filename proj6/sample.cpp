...
const char *WINDOWTITLE = "CS 450 Project #6 -- Annette Tongsak";
...
// ellipse center - move ellipse around
Keytimes NowSc, NowTc;
// ellipse radii - change radius of ellipse
float NowRs, NowRt;
GLSLProgram Pattern;
...
Display( )
{
	...
	if(KeytimePatternOn){
		sc = NowSc.GetValue(nowTime); 
		tc = NowTc.GetValue(nowTime);
	} 
	else{
		sc = 0.5;
		tc = 0.5;
...
InitGraphics( )
{
	// pick at least 4 keytime positions for Sc and Tc. 
	// Remember that they need to be between 0. and 1.

	// ellipse center - uSc, uTc
	NowSc.Init();
	// NowSc.AddTimeValue(0, 0.5);
	// NowSc.AddTimeValue(10, 0.5);
	NowSc.AddTimeValue(0, 0.25);
	NowSc.AddTimeValue(2, 0.35);
	NowSc.AddTimeValue(4, 0.45);
	NowSc.AddTimeValue(6, 0.5);
	NowSc.AddTimeValue(8, 0.55);
	NowSc.AddTimeValue(10, 0.65);

	// NowSc.AddTimeValue(0, 0.25);
	// NowSc.AddTimeValue(3, 0.5);
	// NowSc.AddTimeValue(6, 0.75);
	// NowSc.AddTimeValue(9, 0.5);
	// NowSc.AddTimeValue(10, .25);
	

	NowTc.Init();
	// NowTc.AddTimeValue(0, 0.5);
	// NowTc.AddTimeValue(10, 0.5);

	NowTc.AddTimeValue(0, 0.25);
	NowTc.AddTimeValue(2, 0.5);
	NowTc.AddTimeValue(4, 0.75);
	NowTc.AddTimeValue(8, 0.5);
	NowTc.AddTimeValue(10, 0.25);
	...
	Pattern.SetUniformVariable( "uColor", 1.f, 0.f, 0.f );
